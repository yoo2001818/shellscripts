...
import { create, edit } from '../../actions/comment.js';
...
class CommentForm extends Component {
  ...
  render() {
    ...
    const { fields: { description }, handleSubmit, author } = this.props;
    return (
        ...
        <div className='comment-card'>
          ...
          <div className='container'>
            ...
            <div className='description'>
              <ErrorShow placeholder={__('description')} noSuccess
                {...description}>
                <AutoExpandTextArea placeholder={__('description')}
                  className='dotted noresize' noNewLine {...description} />
              </ErrorShow>
            </div>
          </div>
        </div>
